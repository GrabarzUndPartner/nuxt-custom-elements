<template>
  <svg
    ...
    <path
      fill="#3b7f72"
      d="M0 121.5V63.1C0 61.3 1.4 60 3.1 60h13.8c1.7 0 3.1 1.4 3.1 3.1v58.4H0z" />
    <path
      fill="#2f495e"
      d="M67.2 74.1v18.4H49.1V74.1h18.1m14.1-14.2H46.4c-6.3 0-11.5 5.1-11.5 11.5v35.2h34.9c6.3 0 11.5-5.1 11.5-11.5V59.9z" />
    <path
      fill="#3b7f72"
      d="M116.2 45.1v58.4c0 1.7-1.4 3.1-3.1 3.1H99.3c-1.7 0-3.1-1.4-3.1-3.1V45.1h20z" />
    <linearGradient
      id="SVGID_1_"
